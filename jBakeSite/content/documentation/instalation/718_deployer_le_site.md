...
Vous devez avoir un nom de domaine. Cela peut être un nom "par défaut" proposé par votre hébergeur ou un nom de domaine personnalisé (vous devrez alors acheter le Nom de Domaine).
...
Même si WebLeger est par conception sécurisée, soyez vigilant sur la sécurité.
